	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>
					Bank Accounts <small>Add a bank account</small>
				</h1>
				<ol class="breadcrumb">
					<li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
					<li class="active">Add a bank account</li>
				</ol>
			</section>
			<div class="box box-danger">
				<div class="box-header with-border">
					<h3 class="box-title">Add a bank account</h3>
					<h5 style="color:red;">${message } </h5>
					<div class="box-body">
						<form action="addbaccount" method="post">
							<div class="form-group">
								<div class="row">
									<label for="accntname" class="col-lg-2 control-label">Bank Account Name</label>
									<div class="col-lg-4">
										<input type="text" name="accntname" class="col-lg-4 form-control"
											id="accntname">
									</div>
								</div>
							</div>
							<div class="form-group">
								<div class="row">
									<label for="accntbalance" class="col-lg-2 control-label">Opening Balance</label>
									<div class="col-lg-4">
										<input type="text" name="accntbalance" class="col-lg-4 form-control"
											id="accntbalance">
									</div>
								</div>
							</div>
							<div class="form-group">
								<div class="row">
									<label for="accnttype" class="col-lg-2 control-label">Account Type</label>
									<div class="col-lg-4">
										<select name="accnttype" class="col-lg-4 form-control"
											id="accnttype">
							...
							<div class="form-group">
								<div class="row">
									<label for="accntbank" class="col-lg-2 control-label">Bank Name</label>
									<div class="col-lg-4">
										<input type="text" name="accntbank" class="col-lg-4 form-control"
											id="accntbank">
									</div>
								</div>
							</div>
