	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>
					Credit Cards <small>Add a credit card</small>
				</h1>
				<ol class="breadcrumb">
			...
			<div class="box box-danger">
				<div class="box-header with-border">
					<h3 class="box-title">Add a Credit Card</h3>
					<h5 style="color:red;">${message } </h5>
					<div class="box-body">
						<form action="addcc" method="post">
							<div class="form-group">
								<div class="row">
									<label for="cname" class="col-lg-2 control-label">Card Name</label>
									<div class="col-lg-4">
										<input type="text" name="cname" class="col-lg-4 form-control"
											id="cname">
									</div>
								</div>
							</div>
							<div class="form-group">
								<div class="row">
									<label for="climit" class="col-lg-2 control-label">Credit Limit</label>
									<div class="col-lg-4">
										<input type="text" name="climit" class="col-lg-4 form-control"
											id="climit">
									</div>
								</div>
							</div>
							<div class="form-group">
								<div class="row">
									<label for="pddate" class="col-lg-2 control-label">Payment Due Date</label>
									<div class="col-lg-4">
										<input type="text" name="pddate" class="col-lg-4 form-control"
											id="pddate">
									</div>
								</div>
							</div>
							<div class="form-group">
								<div class="row">
									<label for="cissuer" class="col-lg-2 control-label">Card Issuer</label>
									<div class="col-lg-4">
										<input type="text" name="cissuer" class="col-lg-4 form-control"
											id="cissuer">
									</div>
								</div>
							</div>
							<div class="form-group">
								<div class="row">
									<label for="cperc" class="col-lg-2 control-label">Percentage intended to use</label>
									<div class="col-lg-4">
										<input type="text" name="cperc" class="col-lg-4 form-control"
											id="cperc">
									</div>
								</div>
							</div>
