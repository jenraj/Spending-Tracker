	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>
					Transactions <small>Summary</small>
				</h1>
				<ol class="breadcrumb">
			...
			<div class="box box-danger">
				<div class="box-header with-border">
					<h3 class="box-title">Bank Expenses Summary</h3>
					...
					<div class="box-body" style="max-height:350px; overflow-y:scroll;">
						<table class="table">
							...
							<tbody>
								<c:forEach var="expense" items="${bankexpenselist }">
									<tr>
										<td>${expense.transMonth }/${expense.transDay }/${expense.transYear }</td>
										<td>${expense.transName }</td>
										<td>${expense.transMethod }</td>
										<td>${expense.transAmount }</td>
										<td>${expense.transDesc }</td>
									</tr>
								</c:forEach>
							</tbody>
							<tfoot>
							<tr>
								...
								<th>${betot }</th>
								<th>Total expenses made using bank account(s) till date</th>
							</tr>
							</tfoot>
						</table>
					</div>
			...
			<div class="box box-danger">
				<div class="box-header with-border">
					<h3 class="box-title">Card Expenses Summary</h3>
					...
					<div class="box-body" style="max-height:350px; overflow-y:scroll;">
						<table class="table">
							...
							<tbody>
								<c:forEach var="expense" items="${cardexpenselist }">
									<tr>
										<td>${expense.transMonth }/${expense.transDay }/${expense.transYear }</td>
										<td>${expense.transName }</td>
										<td>${expense.transMethod }</td>
							...
							<tr>
								<th>${serverTime }</th>
								<th>Total</th>
								<th>Multiple Cards</th>
								<th>${cetot }</th>
								<th>Total expenses made using credit card(s) till date</th>
							</tr>
							</tfoot>
						</table>
					</div>
			...
			<div class="box box-danger">
				<div class="box-header with-border">
					<h3 class="box-title">Bank accounts Income Summary</h3>
					...
					<div class="box-body" style="max-height:350px; overflow-y:scroll;">
						<table class="table">
							...
							<tbody>
								<c:forEach var="expense" items="${bankincomelist }">
									<tr>
										<td>${expense.transMonth }/${expense.transDay }/${expense.transYear }</td>
										<td>${expense.transName }</td>
										<td>${expense.transMethod }</td>
							...
							<tr>
								...
								<th>Multiple Accounts</th>
								<th>${bitot }</th>
								<th>Total income recieved at bank account(s)</th>
							</tr>
							</tfoot>
						</table>
					</div>
			...
			<div class="box box-danger">
				<div class="box-header with-border">
					<h3 class="box-title">Credit Card Income Summary</h3>
					...
					<div class="box-body" style="max-height:350px; overflow-y:scroll;">
						<table class="table">
							...
							<tbody>
								<c:forEach var="expense" items="${cardincomelist }">
									<tr>
										<td>${expense.transMonth }/${expense.transDay }/${expense.transYear }</td>
										<td>${expense.transName }</td>
										<td>${expense.transMethod }</td>
							...
							<tr>
								...
								<th>Multiple Cards</th>
								<th>${citot }</th>
								<th>Total income recieved on credit card</th>
							</tr>
							</tfoot>
						</table>
					</div>
